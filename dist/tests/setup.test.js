...
const initTestEngine = async (useNativeArtifacts = false) => {
    const txidMerklerootValidator = () => Promise.resolve(true);
    const getLatestValidatedRailgunTxid = () => Promise.resolve({ txidIndex: undefined, merkleroot: undefined });
    ...
    txidMerklerootValidator, getLatestValidatedRailgunTxid, false // verboseLogging
    );
