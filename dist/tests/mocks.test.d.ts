import { FallbackProviderJsonConfig, FeeTokenDetails, RailgunERC20Amount, RailgunNFTAmountRecipient, RailgunNFTAmount, TransactionGasDetails, RailgunERC20Recipient } from '@railgun-community/shared-models';
import { BalancesUpdatedCallback } from '../services/railgun/wallets/balance-update';
import { CommitmentCiphertextV2, CommitmentCiphertextV3 } from '@railgun-community/engine';
...
export declare const MOCK_RAILGUN_WALLET_ADDRESS = "0zk1q8hxknrs97q8pjxaagwthzc0df99rzmhl2xnlxmgv9akv32sua0kfrv7j6fe3z53llhxknrs97q8pjxaagwthzc0df99rzmhl2xnlxmgv9akv32sua0kg0zpzts";
...
export declare const MOCK_TOKEN_AMOUNTS_TOKEN_1_ONLY: RailgunERC20Amount[];
export declare const MOCK_TOKEN_AMOUNTS: RailgunERC20Amount[];
export declare const MOCK_ERC20_RECIPIENTS: RailgunERC20Recipient[];
export declare const MOCK_NFT_AMOUNTS: RailgunNFTAmount[];
...
export declare const MOCK_NFT_AMOUNT_RECIPIENTS: RailgunNFTAmountRecipient[];
export declare const MOCK_NFT_AMOUNT_RECIPIENTS_UNSHIELD: RailgunNFTAmountRecipient[];
export declare const MOCK_TOKEN_FEE: RailgunERC20Amount;
