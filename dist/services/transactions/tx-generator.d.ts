import { AdaptID, TransactionStructV2, TransactionStructV3 } from '@railgun-community/engine';
...
export declare const generateUnshieldBaseToken: (txidVersion: TXIDVersion, txs: (TransactionStructV2 | TransactionStructV3)[], networkName: NetworkName, toWalletAddress: string, relayAdaptParamsRandom: string, useDummyProof: boolean | undefined, sendWithPublicWallet: boolean) => Promise<ContractTransaction>;
